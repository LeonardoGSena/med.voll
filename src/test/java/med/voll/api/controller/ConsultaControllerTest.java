...
class ConsultaControllerTest {
    ...
    void agendarCenario2() throws Exception {
        ...
        DadosDetalhamentoConsulta dadosDetalhemento = new DadosDetalhamentoConsulta(null, 2l, 5l, data);
        when(agendaDeConsultas.agendar(any())).thenReturn(dadosDetalhemento);
        ...
        var jsonEsperado = dadosDetalhamentoConsultaJson
                .write(dadosDetalhemento).getJson();
